...
def help_instructions():
    ...
    table.add_row("SET", "сохраняет аргумент "
                         "в базе данных")
    table.add_row(
        "GET",
    ...
    table.add_row(
        "COUNTS", "показывает сколько"
                  " раз данные значение встречается в базе данных."
    )
    table.add_row(
        "FIND", "выводит найденные"
                " установленные переменные для данного значения."
    )
