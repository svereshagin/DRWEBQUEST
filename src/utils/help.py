...
def help_instructions():
    ...
    table.add_row(
        "GET",
        "возвращает, ранее сохраненную переменную. Если такой переменной не было сохранено, возвращает NULL",
    )
    table.add_row(
        "UNSET",
        "удаляет, ранее установленную переменную. Если значение не было установлено, не делает ничего.",
    )
    table.add_row(
...
def welcome_user():
    return richpr(
        "[green]This is a DataBase sample[/green]\n",
